...
void Command::createCommandPool(const VkPhysicalDevice& physicalDevice, const VkDevice& device,
...
void Command::endSingleTimeCommands(const VkDevice& device, const VkQueue& graphicsQueue,
                                    VkCommandBuffer& commandBuffer) {
...
void Command::copyBufferToImage(const VkQueue& graphicsQueue, VkBuffer buffer, VkImage image, uint32_t width,
                                uint32_t height) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands(device);
...
void Command::transitionImageLayout(const VkQueue& graphicsQueue, VkImage image, VkFormat format,
