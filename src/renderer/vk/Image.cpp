...
void createImageViews(const VkDevice& device, const std::vector<VkImage>& images, const VkFormat& format,
...
void createDepthResources(const VkDevice& device, const VkPhysicalDevice& physicalDevice,
                          const VkExtent2D& swapChainExtent, VkImage& depthImage, VkDeviceMemory& depthImageMemory,
