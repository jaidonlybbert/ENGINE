...
static const std::vector<const char*> deviceExtensions{
    ...
    "VK_KHR_portability_subset", VK_KHR_GET_MEMORY_REQUIREMENTS_2_EXTENSION_NAME,
...
class PhysicalDevice {
   public:
    ...
    static void pickPhysicalDevice(const VkInstance& instance, VkPhysicalDevice& physicalDevice,
