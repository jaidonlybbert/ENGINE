...
void Pipeline::Initialize(const VkRenderPass& renderPass, const ShaderFactory& shader_fac,
...
const VkDescriptorSetLayout& Pipeline::getDescriptorSetLayout() const { return descriptorSetLayout; }
