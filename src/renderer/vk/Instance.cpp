...
void InstanceFactory::DestroyDebugUtilsMessengerEXT(VkInstance instance, VkDebugUtilsMessengerEXT debugMessenger,
                                                    const VkAllocationCallbacks* pAllocator) {
...
VKAPI_ATTR VkBool32 VKAPI_CALL InstanceFactory::debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
