...
Buffer::Buffer(const VkDevice& device, const VkPhysicalDevice& physicalDevice, const size_t element_size_bytes,
               const VkDeviceSize size, const VkBufferUsageFlags usage, const VkMemoryPropertyFlags properties)
    : device(device), physicalDevice(physicalDevice), total_size_bytes(size), element_size_bytes(element_size_bytes) {
...
void Buffer::createBuffer(const VkDeviceSize size, const VkBufferUsageFlags usage,
