...
template <>
std::vector<VkVertexInputAttributeDescription> MeshAdapter::getAttributeDescriptions<VertexPosColTex>() {
...
template <>
std::vector<VkVertexInputAttributeDescription> MeshAdapter::getAttributeDescriptions<VertexPosNorCol>() {
    std::vector<VkVertexInputAttributeDescription> attributeDescriptions{3};
...
template <>
std::vector<VkVertexInputAttributeDescription> MeshAdapter::getAttributeDescriptions<VertexPosNorTex>() {
    std::vector<VkVertexInputAttributeDescription> attributeDescriptions{3};
...
template <>
std::vector<VkVertexInputAttributeDescription> MeshAdapter::getAttributeDescriptions<VertexPos>() {
