...
enum ComponentType { BYTE, UNSIGNED_BYTE, SHORT, UNSIGNED_SHORT, UNSIGNED_INT, FLOAT };
...
std::unordered_map<AccessorType, std::string> accessor_type_to_string{
    {AccessorType::SCALAR, "SCALAR"}, {AccessorType::VEC2, "VEC2"}, {AccessorType::VEC3, "VEC3"},
    {AccessorType::VEC4, "VEC4"},     {AccessorType::MAT2, "MAT2"}, {AccessorType::MAT3, "MAT3"},
...
enum MeshPrimitiveMode { POINTS, LINES, LINE_LOOP, LINE_STRIP, TRIANGLES, TRIANGLES_STRIP, TRIANGLE_FAN };
